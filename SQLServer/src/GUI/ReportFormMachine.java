...
public class ReportFormMachine extends javax.swing.JFrame {
   private abstractReportByMachine reportAboutMachinePanel;
    ...
    public ReportFormMachine(DBInfo dbInfo,
        ...
        reportAboutMachinePanel = new dailyReportByMachine (dbInfo,machineId, dateStart,dateEnd, hourStart, hourEnd,workHours,morningWorkHours,eveningWorkHours,shiftSplit,"06:30","19:00","19:00","06:30",fridayWorkHours,saturdayWorkHours,typeReport);
        ...
        jLabel5.setText(hourStart);
        jLabel6.setText(dateStart); //
        
        jLabel7.setText(hourEnd );
    ...
    private void initComponents() {
        ...
        jLabel1.setText("עד שעה");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 50, 80, 30));

        jLabel2.setText("תאריך - ");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 60, 120, -1));

        jLabel3.setText("משעה       ");
        ...
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 10, 160, -1));
        ...
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 10, -1, 20));
        ...
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 10, 150, 20));
        ...
        jPanel1.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 10, 230, -1));
