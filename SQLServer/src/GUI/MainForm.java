...
public class MainForm extends javax.swing.JFrame {
    ...
    */
    ...
    public MainForm() {
        ...
        labelsToDoHoverEffectOn.add(jLabel40);
        labelsToDoHoverEffectOn.add(jLabel37);
    ...
    private void initComponents() {
        ...
        reportMachineTitle.setBounds(360, 0, 170, 50);
        ...
        jDateChooser1.setBounds(280, 230, 170, 30);
        ...
        jDateChooser2.setBounds(500, 230, 170, 30);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("עד");
        machineReportPanel.add(jLabel2);
        jLabel2.setBounds(470, 290, 30, 30);
        ...
        jLabel50.setBounds(440, 180, 80, 20);
        ...
        breakInputTextField.setBounds(500, 360, 170, 30);
        ...
        workersSetPanel.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        workersSetPanel.add(removeWorkerLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 380, 100, 20));
        ...
        workersSetPanel.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 380, 80, 20));
        workersSetPanel.add(numWorkerTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 380, 90, -1));
        workersSetPanel.add(nameWorkerTextField, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 380, 90, -1));

        jLabel16.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel16.setText("שם עובד");
        workersSetPanel.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 370, 70, 40));
        ...
        workersSetPanel.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 380, 100, 20));

        mainPanel.add(workersSetPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 150, 950, 470));

        machinesSetPanel.setBackground(new java.awt.Color(242, 242, 242));
        machinesSetPanel.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        machinesSetPanel.add(removeWorkerLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 350, 100, 20));
        ...
        machinesSetPanel.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, 110, 20));

        jLabel20.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel20.setText("זמן כיפוף");
        machinesSetPanel.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 400, 70, 20));

        jTextField1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        machinesSetPanel.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 340, 70, -1));

        jLabel21.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel21.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel21.setText("מספר מכונה");
        machinesSetPanel.add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 370, 100, -1));

        jTextField2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        machinesSetPanel.add(jTextField2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 400, 70, -1));

        jLabel23.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel23.setText("זמן טעינה");
        machinesSetPanel.add(jLabel23, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 340, 70, 20));

        jTextField4.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        machinesSetPanel.add(jTextField4, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 400, 70, -1));

        jLabel24.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel24.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel24.setText("זמן חיתוך");
        machinesSetPanel.add(jLabel24, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 400, 100, -1));

        jTextField5.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        machinesSetPanel.add(jTextField5, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 370, 70, -1));

        jLabel25.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel25.setText("מהירות");
        machinesSetPanel.add(jLabel25, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 370, 60, 20));

        jTextField6.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        machinesSetPanel.add(jTextField6, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 370, 70, -1));

        jLabel26.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel26.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel26.setText("שם מכונה");
        machinesSetPanel.add(jLabel26, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 340, 100, -1));

        jTextField7.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        machinesSetPanel.add(jTextField7, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 340, 70, -1));

        mainPanel.add(machinesSetPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(35, 150, 950, 470));

        materialsSetPanel.setBackground(new java.awt.Color(242, 242, 242));
        materialsSetPanel.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        materialsSetPanel.add(workerSetTitle2, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 0, 190, 40));
        ...
        materialsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "diameterMM", "weightMeter", "numOfWirestS1", "numOfWiresS2", "numOfWires14", "numOfWires16", "MiniSyntax", "Planet20", "EvgPbc", "RaXa"
            }
        ) {
            boolean[] canEdit = new boolean [] {
        ...
        materialsSetPanel.add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 1010, 280));
        ...
        materialsSetPanel.add(jLabel22, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 520, -1, 20));
        ...
        materialsSetPanel.add(jLabel28, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 520, 130, 20));

        jLabel29.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel29.setText("numOfWiresFormatS2");
        materialsSetPanel.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 410, -1, 20));

        jLabel30.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel30.setText("weightMeterPerKilo");
        materialsSetPanel.add(jLabel30, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 380, 120, 20));

        jTextField11.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        materialsSetPanel.add(jTextField11, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 410, 70, -1));

        jLabel31.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel31.setText("numOfWiresFormatS1");
        materialsSetPanel.add(jLabel31, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 410, -1, 20));

        jTextField12.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        materialsSetPanel.add(jTextField12, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 380, 70, -1));

        jLabel32.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel32.setText("diameterMM");
        materialsSetPanel.add(jLabel32, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 380, -1, 20));

        jTextField47.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        materialsSetPanel.add(jTextField47, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 470, 70, -1));
        ...
        materialsSetPanel.add(jLabel80, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 440, -1, 20));

        jTextField27.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        materialsSetPanel.add(jTextField27, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 440, 70, -1));
        ...
        materialsSetPanel.add(jTextField32, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 500, 70, -1));

        jTextField33.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        materialsSetPanel.add(jTextField33, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 380, 70, -1));

        jTextField34.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        materialsSetPanel.add(jTextField34, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 410, 70, -1));

        jLabel34.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel34.setText("numOfWiresFormat14");
        materialsSetPanel.add(jLabel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 440, -1, 20));

        jTextField14.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        materialsSetPanel.add(jTextField14, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 440, 70, -1));

        jLabel35.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel35.setText("miniSyntax");
        materialsSetPanel.add(jLabel35, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 470, -1, 20));

        jTextField15.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        materialsSetPanel.add(jTextField15, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 470, 70, -1));

        jLabel36.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel36.setText("planet20");
        materialsSetPanel.add(jLabel36, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 470, -1, 20));

        jLabel38.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel38.setText("Ra-Xa20/6");
        materialsSetPanel.add(jLabel38, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 500, -1, 20));

        jLabel39.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel39.setText("EvgPbc");
        materialsSetPanel.add(jLabel39, new org.netbeans.lib.awtextra.AbsoluteConstraints(940, 500, -1, 20));

        jTextField19.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        materialsSetPanel.add(jTextField19, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 500, 70, -1));

        mainPanel.add(materialsSetPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 150, 1030, 570));

        shiftsSetPanel.setBackground(new java.awt.Color(242, 242, 242));
        shiftsSetPanel.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        ...
        jLabel37.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/icons8_add_16px.png"))); // NOI18N
        jLabel37.setText("הוסף משמרת");
        jLabel37.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel37MouseClicked(evt);
            }
        });
        shiftsSetPanel.add(jLabel37, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 420, -1, 30));

        jLabel40.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel40.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/icons8_delete_16px.png"))); // NOI18N
        jLabel40.setText("מחק משמרת");
        jLabel40.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel40MouseClicked(evt);
            }
        });
        shiftsSetPanel.add(jLabel40, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 350, 130, -1));

        jLabel41.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel41.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel41.setText("זמן סיום");
        shiftsSetPanel.add(jLabel41, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 380, 100, 20));

        jTextField17.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        shiftsSetPanel.add(jTextField17, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 380, 70, -1));

        jTextField21.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        shiftsSetPanel.add(jTextField21, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 350, 70, -1));

        jLabel43.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel43.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel43.setText("זמן התחלה");
        shiftsSetPanel.add(jLabel43, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 350, 100, 20));

        jTextField22.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        shiftsSetPanel.add(jTextField22, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 350, 70, -1));

        jLabel44.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel44.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel44.setText("סוג משמרת");
        shiftsSetPanel.add(jLabel44, new org.netbeans.lib.awtextra.AbsoluteConstraints(855, 350, 100, 20));

        jLabel45.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel45.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel45.setText("הפסקת קפה 2");
        shiftsSetPanel.add(jLabel45, new org.netbeans.lib.awtextra.AbsoluteConstraints(855, 380, 100, 20));

        jTextField23.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        shiftsSetPanel.add(jTextField23, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 380, 70, -1));

        jLabel46.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel46.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel46.setText("הפסקת קפה 1");
        shiftsSetPanel.add(jLabel46, new org.netbeans.lib.awtextra.AbsoluteConstraints(855, 410, 100, 20));

        jTextField24.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        shiftsSetPanel.add(jTextField24, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 410, 70, -1));

        jLabel47.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel47.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel47.setText("הפסקת אוכל 1");
        shiftsSetPanel.add(jLabel47, new org.netbeans.lib.awtextra.AbsoluteConstraints(855, 440, 100, 20));

        jTextField25.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        shiftsSetPanel.add(jTextField25, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 440, 70, -1));

        jLabel48.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        shiftsSetPanel.add(jLabel48, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 320, -1, 20));

        mainPanel.add(shiftsSetPanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 990, 500));
        ...
        MachineRepChoosePanel.add(titlePanel, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 10, -1, 20));
        ...
        WorkerRepChoosePanel.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 10, -1, 20));
        ...
        MachineEfficRepChoosePanel.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 10, -1, 20));
        ...
        WorkerEfficRepChoosePanel.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 10, -1, 20));
        ...
        MalfunctionRepChoosePanel.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 10, -1, 20));
        ...
        mainPanel.add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-20, 0, 1050, 800));
    ...
    private void jLabel10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel10MouseClicked
       machineName = (String)machinePickComBox.getSelectedItem();
        ...
        double breakInHours = Double.parseDouble     (breakInputTextField.getText());
        ...
        if(isMachineReportYearly){
          ...
          machineReport = new ReportFormMachine(databaseInfo,2,machineName+"-"+id,dateStartReport,dateEndReport,hourStartReport,hourEndReport,splitIntoTwoShifts,0,(String)jComboBox2.getSelectedItem(),(String)jComboBox1.getSelectedItem(),""+yearStart,""+yearEnd,"","",shiftsTableName);
          machineReport.setVisible(true); 
        } else
        if(isMachineReportMonthly){
         ...
         machineReport = new ReportFormMachine(databaseInfo,3,machineName+"-"+id,dateStartReport,dateEndReport,hourStartReport,hourEndReport,splitIntoTwoShifts,0,(String)jComboBox2.getSelectedItem(),(String)jComboBox1.getSelectedItem(),""+yearStart,""+yearEnd,monthStartStr,monthEndStr,shiftsTableName);
         machineReport.setVisible(true); 
        }
        } 
